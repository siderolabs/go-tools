...
#
# Generated on 2026-05-05T08:38:58Z by kres 1762ab2.
...
.PHONY: image-signer-linux-amd64
image-signer-linux-amd64: $(ARTIFACTS)/image-signer-linux-amd64  ## Builds executable for image-signer-linux-amd64.

.PHONY: $(ARTIFACTS)/image-signer-linux-arm64
$(ARTIFACTS)/image-signer-linux-arm64:
	@$(MAKE) local-image-signer-linux-arm64 DEST=$(ARTIFACTS)

.PHONY: image-signer-linux-arm64
...
image-image-signer:  ## Builds image for image-signer.
	@$(MAKE) registry-$@ IMAGE_NAME="image-signer"
